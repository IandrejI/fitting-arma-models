...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Fit brute force heuristic with P in [0,5] and Q in [0,5] and forecast 5 periods
		int[] p = {0,1,2,3,4,5};
		int[] q = {0,1,2,3,4,5};	
		...
		// Print values of forecast to show difference of true and false in forecast-method 
